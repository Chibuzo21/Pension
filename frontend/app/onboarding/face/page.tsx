...
export default function OnboardingFacePage() {
  ...
  async function handleFaceDone() {
    // Advance Clerk metadata to next step so middleware lets them through
    ...
    <div className='min-h-screen flex bg-[#001407]'>
      ...
      <div className='hidden lg:flex w-80 shrink-0 flex-col justify-between px-10 py-12'>
        <div>
          ...
          <div className='space-y-6'>
            {[
              ...
              {
                n: "02",
                label: "Set up face recognition",
                done: false,
                active: true,
              },
              { n: "03", label: "Record your voice", done: false },
        ...
        <p className='text-white/20 text-[10px] leading-relaxed'>
          Your face data is encrypted and stored securely. It is only used to
          verify your identity during monthly pension verification.
        </p>
      </div>
      ...
      <div className='flex-1 relative flex flex-col items-center justify-center bg-[#f6f9f6] px-6 sm:px-10 py-12'>
        ...
        <div className='w-full max-w-lg'>
          ...
          <p className='text-[13px] text-muted-foreground mb-7 leading-relaxed'>
            Look directly at the camera. We'll capture a few frames to build
            your face profile for monthly verification.
          </p>
          ...
          <p className='text-center text-[10px] text-[#a0b0a0] mt-6'>
            Step 2 of 4 — you can retake if the capture doesn't look right
          </p>
        </div>
      </div>
    </div>
